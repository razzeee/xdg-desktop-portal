...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ModelSession, g_object_unref)
...
GVariant *model_response_options_from_vardict (GVariant  *arg_options,
                                               GError   **error);

GVariant *model_token_options_from_vardict (GVariant  *arg_options,
                                            GError   **error);

GVariant *model_request_options_from_vardict (GVariant  *arg_options,
                                              GError   **error);
