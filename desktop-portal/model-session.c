...
static XdpOptionKey token_options[] = {
  { "handle_token", G_VARIANT_TYPE_STRING, NULL },
  { "maximum_response_tokens", G_VARIANT_TYPE_INT64, NULL },
  { "temperature", G_VARIANT_TYPE_DOUBLE, NULL },
  { "execution_mode", G_VARIANT_TYPE_STRING, NULL },
...
static XdpOptionKey speech_options[] = {
  { "handle_token", G_VARIANT_TYPE_STRING, NULL },
  { "source_language_hint", G_VARIANT_TYPE_STRING, NULL },
  { "execution_mode", G_VARIANT_TYPE_STRING, NULL },
};
...
static GVariant *
model_options_from_vardict (GVariant      *arg_options,
                            XdpOptionKey  *allowed_options,
                            gsize          allowed_options_len,
                            const char    *format,
                            GError       **error)
{
  ...
  if (!xdp_filter_options (arg_options, &options_builder,
                           allowed_options, allowed_options_len,
                           NULL, error))
    return NULL;
  ...
  if (g_strcmp0 (format, "response") == 0)
    return g_variant_ref_sink (g_variant_new ("(xdsss)",
                                              ...
                                              execution_mode));
  if (g_strcmp0 (format, "token") == 0)
    return g_variant_ref_sink (g_variant_new ("(xds)",
                                              maximum_response_tokens,
                                              temperature,
                                              execution_mode));
  if (g_strcmp0 (format, "speech") == 0)
...
GVariant *
model_response_options_from_vardict (GVariant  *arg_options,
                                     GError   **error)
{
  return model_options_from_vardict (arg_options,
                                     response_options,
...
GVariant *
model_token_options_from_vardict (GVariant  *arg_options,
                                  GError   **error)
{
  return model_options_from_vardict (arg_options,
                                     token_options,
...
GVariant *
model_request_options_from_vardict (GVariant  *arg_options,
                                    GError   **error)
{
  return model_options_from_vardict (arg_options,
                                     request_options,
...
GVariant *
model_speech_options_from_vardict (GVariant  *arg_options,
                                   GError   **error)
{
  return model_options_from_vardict (arg_options,
                                     speech_options,
